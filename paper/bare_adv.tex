...
pdftitle={Viterbi algorithm},
pdfsubject={Typesetting},%<!CHANGE!
pdfauthor={Tobias Schellien, Philipp Copei, Robert Koczula, Akanchha Choudhary},
pdfkeywords={Viterbi algorithm, Viterbi, algorithm, HMM, IEEE, journal, paper}}%<^!CHANGE!
%\ifCLASSINFOpdf
...
\author{Tobias Schellien, Philipp Copei, Robert Koczula, Akanchha Choudhary% <-this % stops a space
...
%{Shell \MakeLowercase{\textit{et al.}}: Viterbi algorithm}
